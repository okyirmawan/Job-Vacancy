...
const AdminEditJob = () => {
    ...
    const handleSubmit = (event) => {
        ...
        // update
        axios.put(`https://dev-example.sanbercloud.com/api/job-vacancy/${id}`, job, {headers: {"Authorization" : "Bearer "+ Cookies.get('token')}})
            .then((res) => {
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <form onSubmit={handleSubmit}>
                <div className="relative z-0 mb-6 w-full group">
                    <input type="text" name="title" id="floating_title" onChange={handleInput} value={job.title}
                ...
                <div className="relative z-0 mb-6 w-full group">
                    <input type="text" name="job_description" onChange={handleInput} value={job.job_description}
                ...
                <div className="relative z-0 mb-6 w-full group">
                    <input type="text" name="job_qualification" onChange={handleInput} value={job.job_qualification}
                ...
                <div className="grid md:grid-cols-2 md:gap-6">
                    <div className="relative z-0 mb-6 w-full group">
                        <input type="text" name="job_type" onChange={handleInput} value={job.job_type}
                    ...
                    <div className="relative z-0 mb-6 w-full group">
                        <input type="text" name="job_tenure" onChange={handleInput} value={job.job_tenure}
                ...
                <div className="grid md:grid-cols-2 md:gap-6">
                    <div className="relative z-0 mb-6 w-full group">
                        <input type="number" name="job_status" onChange={handleInput} value={job.job_status}
                               id="floating_phone"
                               className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    ...
                    <div className="relative z-0 mb-6 w-full group">
                        <input type="text" name="company_name" onChange={handleInput} value={job.company_name}
                               id="floating_company"
                               className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                               placeholder=" " required/>
                        <label
                ...
                <div className="grid md:grid-cols-2 md:gap-6">
                    <div className="relative z-0 mb-6 w-full group">
                        <input type="text" name="company_image_url" onChange={handleInput} value={job.company_image_url}
                               id="floating_phone"
                               className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                               placeholder=" " required/>
                        <label
                    ...
                    <div className="relative z-0 mb-6 w-full group">
                        <input type="text" name="company_city" onChange={handleInput} value={job.company_city}
                               id="floating_company"
                               className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                               placeholder=" " required/>
                        <label
                ...
                <div className="grid md:grid-cols-2 md:gap-6">
                    <div className="relative z-0 mb-6 w-full group">
                        <input type="number" name="salary_min" onChange={handleInput} value={job.salary_min}
                               id="floating_phone"
                               className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                               placeholder=" " required/>
                        <label
                    ...
                    <div className="relative z-0 mb-6 w-full group">
                        <input type="number" name="salary_max" onChange={handleInput} value={job.salary_max}
                               id="floating_company"
                               className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                               placeholder=" " required/>
                        <label
                ...
                <button type="submit"
                        className="text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-indigo-700 dark:hover:bg-indigo-800 dark:focus:ring-indigo-900">Edit
                </button>
            </form>
            ) : (
                <p>Loading...</p>
